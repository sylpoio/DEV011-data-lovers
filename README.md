...
- [1. Definición del producto](#1-producto)
- [2. Historias de usuario](#2-historias-de-usuario)
- [3. Diseño de interfaz de usuario](#3-dieño-inerfaz)
- [3.1 Diseño de baj fidelidad](#3.1-diseño-baja)
- [3.2 diseño de alta fidelidad](#3.2-diseño-alta)
- [4. Testeos de usabilidad](#4-testeos)
-
...
Nuestra página está desarollada para ayudar a los fans de Studios Ghibli a consultar información relevante de las animaciones del estudio.
Permite consultar datos como director, productor, año de lanzamiento, entre otros. Permitiendo filtrar la información por dichos campos y contando la cantidad de películas a las que se aplica dicho filtro.
De la misma forma da información detallada de cada película como descripción, personajes, locaciones y vehículos utilizados.

## 2. Historias de usuario

Se desarollaron 5 historias de usuario basadas en los resultados de la investigación compartida.
...
1. Primera historia de usuario: cuerpo de la página
  ...
  Tareas
    ...
    Imágenes: elegir si serán extraídas de otra página o cargadas en la interfaz (Header y background)
...
3. Tercera historia de usuario: creación de filtros
  Descripción
    Personas interesadas en las películas de Studios Ghibli
    Conocer la cinematografía de Ghibli
...
5. Quinta historia de usuario: estadisticas  generales de las pelÍculas
  Descripción
    Personas interesadas en las películas de Studios Ghibli
    Conocer la cinematografía de Ghibli
    Dato más relevante que quieren: información del número de las películas
    ...
    COMO: como usuario de la página
    QUIERO: Ver el número de películas que dirigió el mismo director, o tuvieron el mismo productor
    PARA: Saber tendencias

  Tareas
    Crear el HTML
    Crear el diseño CSS
    Agregar el número dinámico
    Crear la función para que el número cambie al ser filtrada la información

  Criterios de aceptación
    El usuario puede de ver el número 
    El usuario puede visualizar el número y filtrarlo dinámicamente
...
- La interfaz debe estructurar semánticamente la data usando el estándar [microdatos](https://developer.mozilla.org/en-US/docs/Web/HTML/Microdata).
  ...
  <dl itemscope itemtype="pokemon">
    <dt>Name:</dt>
    <dd itemprop="name">pikachu</dd>
    <dt>Number:</dt>
    <dd itemprop="num">025</dd>
    <dt>Rarity:</dt>
    <dd itemprop="pokemon-rarity">normal</dd>
  </dl>
  ```
